    ...
    public partial class Form1 : Form
    {
        ...
        async private void POST_Click(object sender, EventArgs e)
        {
            ...
            HttpWebRequest requestarea = (HttpWebRequest)WebRequest.Create(
               $"http://localhost/heheruapi/areas?AreaName=" + name_area);
            ...
            HttpWebRequest requesexp = (HttpWebRequest)WebRequest.Create(
               $"http://localhost/heheruapi/experiences?ExperienceName=" + name_experience);
            ...
            HttpWebRequest requestspec = (HttpWebRequest)WebRequest.Create(
               $"http://localhost/heheruapi/specializations?SpecializationName=" + spec_name);
            ...
            {
                using (var request = new HttpRequestMessage(new HttpMethod("POST"), "http://localhost/heheruapi/vacancies"))
                {
            ...
            using (var httpClient = new HttpClient())
            {
                using (var request = new HttpRequestMessage(new HttpMethod("POST"), "http://localhost/heheruapi/areas"))
                {
            ...
            using (var httpClient = new HttpClient())
            {
                using (var request = new HttpRequestMessage(new HttpMethod("POST"), "http://localhost/heheruapi/experiences"))
                {
            ...
            using (var httpClient = new HttpClient())
            {
                using (var request = new HttpRequestMessage(new HttpMethod("POST"), "http://localhost/heheruapi/specializations"))
                {
            ...
            using (var httpClient = new HttpClient())
            {
                using (var request = new HttpRequestMessage(new HttpMethod("POST"), "http://localhost/heheruapi/vacancies_skills"))
                {
            ...
            using (var httpClient = new HttpClient())
            {
                using (var request = new HttpRequestMessage(new HttpMethod("POST"), "http://localhost/heheruapi/vacancies_specializations"))
                {
        ...
        async private void DELETE_Click(object sender, EventArgs e)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                using (var request = new HttpRequestMessage(new HttpMethod("DELETE"), "http://localhost/heheruapi/vacancies/"+id_vacancy))
                {
                    var response = await httpClient.SendAsync(request);
                }
            }
        ...
        async private void PUT_Click(object sender, EventArgs e)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                using (var request = new HttpRequestMessage(new HttpMethod("PUT"), $"http://localhost/heheruapi/vacancies/{id_vacancy}"))
                {
                    request.Content = new StringContent($"id_vacancy={id_vacancy}&description={description}&name={name}" +
                        $"&published_at={published_at}&salary_currency={salary_currency}&salary_from={salary_from}" +
                        $"&salary_to={salary_to}&snippet_requirement={snippet_requirement}&snippet_responsibility={snippet_responsibility}" +
            ...
            using (var httpClient = new HttpClient())
            {
                using (var request = new HttpRequestMessage(new HttpMethod("PUT"), "http://localhost/heheruapi/areas"))
                {
                    request.Content = new StringContent($"id_area={id_area}&name={name_area}");
                    request.Content.Headers.ContentType = MediaTypeHeaderValue.Parse("application/x-www-form-urlencoded");
                    var response = await httpClient.SendAsync(request);
            ...
            using (var httpClient = new HttpClient())
            {
                using (var request = new HttpRequestMessage(new HttpMethod("PUT"), "http://localhost/heheruapi/experiences"))
                {
                    request.Content = new StringContent($"id_experience={id_experience}&name={name_experience}");
                    request.Content.Headers.ContentType = MediaTypeHeaderValue.Parse("application/x-www-form-urlencoded");
                    var response = await httpClient.SendAsync(request);
            ...
            using (var httpClient = new HttpClient())
            {
                using (var request = new HttpRequestMessage(new HttpMethod("PUT"), "http://localhost/heheruapi/specializations"))
                {
                    request.Content = new StringContent($"id_specialization={id_specialization}&name={spec_name}");
                    request.Content.Headers.ContentType = MediaTypeHeaderValue.Parse("application/x-www-form-urlencoded");
                    var response = await httpClient.SendAsync(request);
            ...
            using (var httpClient = new HttpClient())
            {
                using (var request = new HttpRequestMessage(new HttpMethod("PUT"), "http://localhost/heheruapi/vacancies_skills"))
                {
                    request.Content = new StringContent($"id_vacancy={id_vacancy}&id_skill={id_skills}");
                    request.Content.Headers.ContentType = MediaTypeHeaderValue.Parse("application/x-www-form-urlencoded");
                    var response = await httpClient.SendAsync(request);
            ...
            using (var httpClient = new HttpClient())
            {
                using (var request = new HttpRequestMessage(new HttpMethod("PUT"), "http://localhost/heheruapi/vacancies_specializations"))
                {
                    request.Content = new StringContent($"id_vacancy={id_vacancy}&id_specialization={id_specialization}");
                    request.Content.Headers.ContentType = MediaTypeHeaderValue.Parse("application/x-www-form-urlencoded");
                    var response = await httpClient.SendAsync(request);
